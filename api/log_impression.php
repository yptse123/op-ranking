...
try {
    ...
    $sql = "UPDATE banner SET impression = impression + 1 WHERE id = :id";
    ...
    $id = PM::getSingleton("Database")->insertRow("banner_impression_log", $sqlData);
    ...
    echo json_encode([
        'status' => 'success',
        'message' => 'Impression log success',
        'log_id' => $id
    ]);

} catch (Exception $e) {
    error_log('log_impression.php error: ' . $e->getMessage());
